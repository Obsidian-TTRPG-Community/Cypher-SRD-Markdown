...
> [!hint]- Another Way to Think About Armor and Speed
> Some people find the above table confusing. Here’s another way to put it (as confirmed by Sean K. Reynolds on [Twitter](https://twitter.com/seankreynolds/status/1341829517409615872)):
>
> When you are wearing armor, perform a speed-based action, and apply effort, each level of effort costs more points from your speed pool:
>
...
>
> One of the “Other Options” for Character Advancement reduces the speed cost of armor by 1, and can be taken multiple times.
>
> There is no “Using Armor” skill, so characters are not “practiced in using armor” by default, and they cannot have an inability, or be trained or specialised in it.
>
> *Source: Thanks to [Cypher System Reference](https://gitlab.com/Screwtapello/cypher-system-reference)*
...
Other sorts of miscellaneous items can be found in the Genres chapter.
...
For GM information on artifacts, see the [[Rules/Cypher/Running-the-Cypher-System-cyr|Running the Cypher System]] chapter.
